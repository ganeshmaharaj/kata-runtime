...
func (conf *Config) HypervisorCtlAssetPath() (string, error) {
	return conf.assetPath(types.HypervisorCtlAsset)
}

// JailerAssetPath returns the VM Jailer path
func (conf *Config) JailerAssetPath() (string, error) {
...
type Hypervisor interface {
	CreateSandbox(ctx context.Context, id string, networkNS NetworkNamespace, hypervisorConfig *Config, store *store.VCStore) error
	StartSandbox(timeout int) error
	StopSandbox() error
	PauseSandbox() error
	SaveSandbox() error
	ResumeSandbox() error
	AddDevice(devInfo interface{}, devType Device) error
	HotplugAddDevice(devInfo interface{}, devType Device) (interface{}, error)
	HotplugRemoveDevice(devInfo interface{}, devType Device) (interface{}, error)
	...
	Cleanup() error
	Pid() int
	FromGrpc(ctx context.Context, hypervisorConfig *Config, store *store.VCStore, j []byte) error
	ToGrpc() ([]byte, error)
