...
func saveTapIf(tapif *types.TapInterface) *persistapi.TapInterface {
	if tapif == nil {
		return nil
	}
...
func loadTapIf(tapif *persistapi.TapInterface) *types.TapInterface {
	if tapif == nil {
		return nil
	}

	return &types.TapInterface{
		ID:   tapif.ID,
		Name: tapif.Name,
...
func saveNetIfPair(pair *types.NetworkInterfacePair) *persistapi.NetworkInterfacePair {
	if pair == nil {
		return nil
	}
...
func loadNetIfPair(pair *persistapi.NetworkInterfacePair) *types.NetworkInterfacePair {
	if pair == nil {
		return nil
	}
	...
	virtif := types.NetworkInterface{
		Name:     savedVirtIf.Name,
		HardAddr: savedVirtIf.HardAddr,
		Addrs:    savedVirtIf.Addrs,
	}

	return &types.NetworkInterfacePair{
		TapInterface:         *tapif,
		VirtIface:            virtif,
		NetInterworkingModel: types.NetInterworkingModel(pair.NetInterworkingModel),
	}
}
