...
func (fc *firecracker) CreateSandbox(ctx context.Context, id string, networkNS NetworkNamespace, hypervisorConfig *Config, vcStore *store.VCStore) error {
	fc.ctx = ctx
...
func (fc *firecracker) FromGrpc(ctx context.Context, hypervisorConfig *Config, store *store.VCStore, j []byte) error {
