...
func (a *acrn) AppendImage(devices []AcrnDevice, imagePath string) ([]AcrnDevice, error) {
	if imagePath == "" {
...
func (a *acrn) buildDevices(imagePath string) ([]AcrnDevice, error) {
	var devices []AcrnDevice
...
func (a *acrn) setup(id string, hypervisorConfig *Config, vcStore *store.VCStore) error {
...
func (a *acrn) createDummyVirtioBlkDev(devices []AcrnDevice) ([]AcrnDevice, error) {
...
func (a *acrn) CreateSandbox(ctx context.Context, id string, networkNS NetworkNamespace, hypervisorConfig *Config, store *store.VCStore) error {
...
func (a *acrn) hotplugAddDevice(devInfo interface{}, devType Device) (interface{}, error) {
...
func (a *acrn) hotplugRemoveDevice(devInfo interface{}, devType Device) (interface{}, error) {
...
func (a *acrn) AddDevice(devInfo interface{}, devType Device) error {
	var err error
...
func (a *acrn) fromGrpc(ctx context.Context, hypervisorConfig *Config, store *store.VCStore, j []byte) error {
